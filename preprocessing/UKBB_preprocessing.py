...
def get_X_and_y(num_nodes, subject_ids, date_column, 
    ...
    for subj_idx, subject_id in enumerate(subject_ids):
        ...
        target_date = subject_id[-8:]
        target_id = subject_id[:-9]
...
np.save(f'/mnt/md0/tempFolder/samAnderson/gnn_model/unet-gnn/datasets/processed/X_UKBB', X_norm)
np.save(f'/mnt/md0/tempFolder/samAnderson/gnn_model/unet-gnn/datasets/processed/y_UKBB', y)
