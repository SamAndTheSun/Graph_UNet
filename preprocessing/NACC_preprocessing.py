...
def make_fsaverage(input_path, output_path, file_type, ico=7):
    ...
    if 'w-g.pct.mgh' in input_path:
        ...
        output_fname_abs = f'{output_path}{input_path.split("/")[subj_dir-3]}_{input_path.split("/")[subj_dir-1]}_{hemi[-2:]}.w-g.pct.mgh'
    else:
        ...
        output_fname_abs = f'{output_path}{input_path.split("/")[subj_dir-3]}_{input_path.split("/")[subj_dir-1]}_{hemi[-2:]}_{".".join(input_path.split(".")[-1:])}.mgh'
...
np.save(f'/mnt/md0/tempFolder/samAnderson/gnn_model/unet-gnn/datasets/processed/X_NACC_CN', X_norm)
np.save(f'/mnt/md0/tempFolder/samAnderson/gnn_model/unet-gnn/datasets/processed/y_NACC_CN', y)